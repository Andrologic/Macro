...
pub(crate) const LIST_TIMEOUT_MILLIS: u64 = 5_000;
pub(crate) const READ_TIMEOUT_MILLIS: u64 = 5_000;
pub(crate) const GLOB_DEFAULT_LIMIT: usize = 200;
pub(crate) const GLOB_MAX_LIMIT: usize = 1_000;
pub(crate) const GLOB_TIMEOUT_MILLIS: u64 = 5_000;
pub(crate) const GREP_DEFAULT_LIMIT: usize = 50;
pub(crate) const GREP_MAX_LIMIT: usize = 200;
pub(crate) const GREP_TIMEOUT_MILLIS: u64 = 30_000;
pub(crate) const GREP_MAX_FILE_BYTES: u64 = 4 * 1024 * 1024;
pub(crate) const GREP_MAX_COLUMNS: usize = 512;
pub(crate) const AST_DEFAULT_LIMIT: usize = 50;
pub(crate) const AST_MAX_LIMIT: usize = 200;
pub(crate) const AST_TIMEOUT_MILLIS: u64 = 30_000;
pub(crate) const AST_MAX_FILE_BYTES: u64 = 4 * 1024 * 1024;
pub(crate) const AST_MATCH_MAX_BYTES: usize = 2 * 1024;
pub(crate) const AST_PATTERN_MAX_BYTES: usize = 16 * 1024;
pub(crate) const AST_CAPTURE_MAX_BYTES: usize = 512;
pub(crate) const AST_CAPTURE_MAX_COUNT: usize = 32;
pub(crate) const AST_CAPTURE_TOTAL_MAX_BYTES: usize = 4 * 1024;
