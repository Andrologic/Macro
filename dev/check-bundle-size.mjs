...
const BUDGETS = [
  ...
  // Macro 0.1.4 adds approval recovery and task-attention state. Its measured
  // chunks are 1,339,506 B for entry, 50,847 B for TaskQueue, and 137,248 B for ja.
  { name: 'entry', pattern: /^index-.*\.js$/, limitBytes: 1_345_000 },
  { name: 'max-chunk', pattern: /\.js$/, limitBytes: 600_000, exclude: /^index-.*\.js$/ },
  { name: 'chat-zone', pattern: /^ChatZone-.*\.js$/, limitBytes: 115_000 },
  { name: 'task-queue', pattern: /^TaskQueue-.*\.js$/, limitBytes: 52_000 },
  ...
  { name: 'locale-fragment-ja', pattern: /^ja-.*\.js$/, limitBytes: 138_000 },
];
