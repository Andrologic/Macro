...
const PROMPT_DEFAULTS = {
  ...
  [PREF_KEYS.PROMPT_ARCHITECT]:
    `${DEFAULT_MODE_PROMPTS[PREF_KEYS.PROMPT_ARCHITECT]}\n15. Do not create a "Finalize plan" strategy node yourself: Macro adds a synthetic finalization task after the terminal strategy nodes and handles the final merge.`,
