...
export const BUILT_IN_TOOLS: Tool[] = [
  ...
  // File reading tool
  {
    ...
    category: 'filesystem',
    status: 'enabled',
    description: 'Read attached files and context documents in this chat',
    icon: 'file-text',
    config: {
      enabled: true,
      visible: true,
  ...
  },
  {
    ...
    category: 'ai',
    status: 'enabled',
    description: 'Load the full instructions for an enabled Macro skill',
    icon: 'sparkles',
    config: {
      enabled: true,
      visible: false,
      chatMode: true,
      chatToolboxVisible: false,
      internal: true,
      locked: true,
    },
  },
  {
    ...
    status: 'enabled',
    description: 'List effective Macro configuration documents without exposing secrets',
    icon: 'settings',
    config: {
      enabled: true,
      visible: false,
  ...
  },
  {
    ...
    category: 'productivity',
    status: 'enabled',
    description: 'Read a sparse Macro JSON configuration document',
    icon: 'settings',
    config: {
      enabled: true,
      visible: false,
  ...
  },
  {
    ...
    category: 'productivity',
    status: 'enabled',
    description: 'Validate a Macro JSON configuration document without writing it',
    icon: 'settings',
    config: {
      enabled: true,
      visible: false,
  ...
  },
  {
    ...
    category: 'productivity',
    status: 'enabled',
    description: 'Patch Macro configuration through validation and approval checks',
    icon: 'settings',
    config: {
      enabled: true,
      visible: false,
  ...
  },
  {
    ...
    category: 'ai',
    status: 'enabled',
    description: 'Read a bundled reference or asset from an enabled Macro skill',
    icon: 'book-open',
    config: {
      enabled: true,
      visible: false,
  ...
  },
  {
    ...
    category: 'terminal',
    status: 'enabled',
    description: 'Run a command in an existing terminal session',
    icon: 'terminal',
    config: {
      enabled: true,
      visible: true,
  ...
  },
  {
    ...
    category: 'terminal',
    status: 'enabled',
    description: 'Read the latest output from a terminal session',
    icon: 'terminal',
    config: {
      enabled: true,
      visible: true,
  ...
  },
  {
    ...
    category: 'terminal',
    status: 'enabled',
    description: 'Stop the active process in a terminal session',
    icon: 'terminal',
    config: {
      enabled: true,
      visible: true,
  ...
  },
  {
    ...
    category: 'productivity',
    status: 'enabled',
    description: 'Read the checklist for the current Architect implementation task',
    icon: 'list-todo',
    config: {
      enabled: true,
      visible: true,
  ...
  {
    id: 'task_todo_update',
    name: 'Update Task Todos',
    category: 'productivity',
    status: 'enabled',
    description: 'Update the checklist for the current Architect implementation task',
    icon: 'list-todo',
    config: {
      enabled: true,
      visible: true,
  ...
  {
    id: 'task_artifact_list',
    name: 'List Task Artifacts',
    category: 'productivity',
    status: 'enabled',
    description: 'List durable artifacts visible to the current Architect implementation task',
    icon: 'file-text',
    config: {
      enabled: true,
      visible: true,
  ...
  {
    id: 'task_artifact_get',
    name: 'Read Task Artifact',
    category: 'productivity',
    status: 'enabled',
    description: 'Read the full content of a visible task artifact',
    icon: 'file-text',
    config: {
      enabled: true,
      visible: true,
  ...
  {
    id: 'task_artifact_put',
    name: 'Store Task Artifact',
    category: 'productivity',
    status: 'enabled',
    description: 'Create or replace a durable artifact for the current Architect implementation task',
    icon: 'file-text',
    config: {
      enabled: true,
      visible: true,
  ...
  },
  {
    ...
    category: 'productivity',
    status: 'enabled',
    description: 'Update the optional label, description, or mutable slug of an Architect plan',
    icon: 'edit',
    config: {
      enabled: true,
      visible: true,
...
export const defaultToolSettings: Record<string, boolean> = {
  ...
  task_artifact_get: true,
  task_artifact_put: true,
  plan_create: true,
  plan_list: true,
  plan_get: true,
  plan_update: true,
