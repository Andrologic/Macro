...
Les archives ne constituent pas une section dépliable dans l'arborescence active. Un bouton compact dans l'en-tête du panneau permet de basculer entre les plans actifs et une vue dédiée aux plans archivés, de façon cohérente avec le mode Implement et sans réserver une barre en bas du panneau. Cette vue conserve les actions de restauration et de suppression sans mélanger les plans archivés aux projets en cours.
