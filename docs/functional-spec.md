...
Avant ce premier envoi, l'instruction de démarrage apparaît dans une notice flottante au-dessus du composer, et non dans l'en-tête de la conversation. La notice disparaît dès que le premier message est accepté. Macro vide alors le composer sans attendre la fin de la préparation. Si l'envoi échoue avant d'être accepté, Macro restaure le brouillon et ses pièces jointes.
